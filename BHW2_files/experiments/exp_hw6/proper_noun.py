...
class ProperNounClassifierPipeline:
    def __init__(self, n_components=2, max_features=30, random_state=42):
        print("ProperNounClassifierPipeline initialized with PCA", n_components, "components and CountVectorizer", max_features, "max features")
...
class ProperNounXGBClassifierPipeline:
    def __init__(self, n_components=2, max_features=30, random_state=42):
        print("ProperNounXGBClassifierPipeline initialized with PCA", n_components, "components and CountVectorizer", max_features, "max features")
        self.pipeline = Pipeline([
            ('proper_noun', ProperNounTransformer()),
            ('unigram', UnigramTransformer(max_features=max_features)),
            ('pca', PCA(n_components=n_components)),
